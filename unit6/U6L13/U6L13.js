...
setPosition("filterNumCategoryInput", (160-((getProperty("filterNumCategoryInput", "width"))/2)), (400-((getProperty("filterNumCategoryInput", "height"))/2)));
setPosition("filterNumCategoryInput", (160-((getProperty("filterNumCategoryInput", "width"))/2)), (400-((getProperty("filterNumCategoryInput", "height"))/2)));
dropdown("filterNumBoundInput", "Max", "Min");
setPosition("filterNumBoundInput", (160-((getProperty("filterNumBoundInput", "width"))/2)), (350-((getProperty("filterNumBoundInput", "height"))/2)));
setPosition("filterNumBoundInput", (160-((getProperty("filterNumBoundInput", "width"))/2)), (350-((getProperty("filterNumBoundInput", "height"))/2)));
textLabel("filterNumOutput", "");
setPosition("filterNumOutput", (160-((getProperty("filterNumOutput", "width"))/2)), (150-((getProperty("filterNumOutput", "height"))/2)));
setPosition("filterNumOutput", (160-((getProperty("filterNumOutput", "width"))/2)), (150-((getProperty("filterNumOutput", "height"))/2)));
